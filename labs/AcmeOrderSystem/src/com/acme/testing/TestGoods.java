...
public class TestGoods {
	...
	public static void main(String[] args) {
		...
		System.
		out.println(anvil + " can ship via Post office? " + anvil.canShipViaPostOffice());
		...
		int index = Collections.binarySearch((List<Good>)Good.getCatalog(), glue);
		System.out.println(Good.getCatalog().get(index));
		index = Collections.binarySearch((List<Good>)Good.getCatalog(), paint);
		System.out.println(index);
		//Found Acme Invisible Paint-2490 (liquid) 294.05307237600465 GALLON in the catalog at location: 3
	}
}
